    ...
    class json:
        ...
        def checkMultiplyer(self, user):
            ...
            try:
                ...
                raise ValueError(
                    "You passed a Username instead of an UserID. Usernames functionality has been removed. Please update your code. Thank you!"
                )
            try:
        ...
        def addBrewcoin(
            self, amount, user, remov=False, usemultiplyer=True, checkMultiplyer=True
        ):
            userClass = user
        ...
        def remBrewcoin(self, **kwargs):
            ...
            if amount < 0:
                raise NiceTry(
                    "YOU GOT CAUGHT HAHHAHAHAHAHAHAHAHAHAHAHAHAHAHAHAHAHAHA\nYou pay the person you stole from **1** brewcoin."
                )
            amount = (
                0 - amount
            )  # https://stackoverflow.com/a/67205684/9654083, we know it's postive since, well... 1 line above
